...
public class EnDictionary {
    ...
    final String[] tenToNineteen = new String[]{"ten", "eleven", "twelve", "thirteen", "fourteen",
            "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"
    };

    final String[] tens = new String[]{"", "", "twenty", "thirty", "forty",
            "fifty", "sixty", "seventy", "eighty", "ninety"
    };

    final String[] hundreds = new String[]{"", "one hundred", "two hundred", "three hundred", "four hundred",
